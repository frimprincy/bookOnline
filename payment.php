			...
			<div class="container">
				<div class="row">
						...
						<div class="input-group-prepend">
							<button type="button" class="btn btn-primary ipay-btn" data-toggle="modal" data-target="#ipayModal"> Click here to Make Payment</button>
						</div>
					</div>
				</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<img src="https://payments.ipaygh.com/app/webroot/img/LOGO-MER02956.png" class="mx-auto d-block logo">
							</div>
							<form action="https://community.ipaygh.com/gateway" id="ipay_checkout" method="post" name="ipay_checkout" target="_blank">
								<div class="modal-body">
									...
									<input name="merchant_key" type="hidden" value="tk_75935230-6c13-11e9-97f4-f23c9170642f">
									<input id="merchant_code" type="hidden" value="TST000000002703">
									<input name="success_url" type="hidden" value="https://stephionline.000webhostapp.com/success.php">
									<input name="cancelled_url" type="hidden" value="https://stephionline.000webhostapp.com/cancle.php">
